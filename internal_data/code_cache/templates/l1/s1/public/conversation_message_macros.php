<?php
// FROM HASH: 0266f717ee3c8e8b794f8e84effea2fc
return array('macros' => array('message' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
    <article class="message message--conversationMessage convMessage-' . $__templater->escape($__vars['message']['message_id']) . ' ' . ($__templater->method($__vars['message'], 'isIgnored', array()) ? ' is-ignored' : '') . ' ' . ($__templater->method($__vars['message'], 'isUnread', array($__vars['lastRead'], )) ? 'is-unread' : '') . ' js-message" data-author="' . ($__templater->escape($__vars['message']['User']['username']) ?: $__templater->escape($__vars['message']['username'])) . '">
	...
	if (($__templater->func('property', array('messageUserElements', ), false) != null) AND $__templater->func('property', array('xbMessageUserElementsCollapse', ), false)) {
		$__finalCompiled .= '
                        <span id="collapse-' . $__templater->escape($__vars['post']['post_id']) . '" class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-xf-init="tooltip" title="' . 'User details' . '" data-target=".convMessage-' . $__templater->escape($__vars['message']['message_id']) . ' .message-userExtras"></span>
                    ';
	}
	$__finalCompiled .= '
            </div>
