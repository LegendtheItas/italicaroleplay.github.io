<?php
// FROM HASH: b62ddab6f6ca99d6ca8d390dccb7c37b
return array('macros' => array('post' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->func('property', array('xbMessageHeader', ), false)) {
		$__finalCompiled .= '
			<div class="message-header">
				' . $__templater->callMacro(null, 'messageheader', array(
			'post' => $__vars['post'],
	...
	$__finalCompiled .= '
		...
		<div class="message-inner">
			<div class="message-cell message-cell--user' . ($__templater->func('property', array('xbMessageUserElementsCollapse', ), false) ? ' message-userExtras-body message-userExtras--collapsible' : '') . '">
				' . $__templater->callMacro('message_macros', 'user_info', array(
		'user' => $__vars['post']['User'],
		'fallbackName' => $__vars['post']['username'],
	), $__vars) . '
				';
	if (($__templater->func('property', array('messageUserElements', ), false) != null) AND $__templater->func('property', array('xbMessageUserElementsCollapse', ), false)) {
		$__finalCompiled .= '
					<span id="collapse-' . $__templater->escape($__vars['post']['post_id']) . '" class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-xf-init="tooltip" title="' . 'User details' . '" data-target="#js-post-' . $__templater->escape($__vars['post']['post_id']) . ' .message-userExtras"></span>
				';
	}
	$__finalCompiled .= '
			</div>
...
'messageheader' => function($__templater, array $__arguments, array $__vars)
{
	$__vars = $__templater->setupBaseParamsForMacro($__vars, false);
	$__finalCompiled = '';
	$__vars = $__templater->mergeMacroArguments(array(
	...
	$__finalCompiled .= '
					<header class="message-attribution message-attribution--split">
						...
						<ul class="message-attribution-opposite message-attribution-opposite--list">
							';
	if (($__vars['post']['user_id'] == $__vars['thread']['user_id']) AND $__templater->func('property', array('xbThreadStarter', ), false)) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
							';
	if ($__vars['post']['User']['is_admin'] AND $__templater->func('property', array('xbAdminIndicator', ), false)) {
		$__finalCompiled .= '
								<li class="tag-adminIndicator"><span class="message-newIndicator message-adminIndicator">' . 'Admin' . '</span></li>
							';
	} else if ($__vars['post']['User']['is_moderator'] AND $__templater->func('property', array('xbModeratorIndicator', ), false)) {
		$__finalCompiled .= '
								<li class="tag-moderatorIndicator"><span class="message-newIndicator message-moderatorIndicator">' . 'Moderator' . '</span></li>
							';
	} else if ($__vars['post']['User']['is_staff'] AND $__templater->func('property', array('xbStaffIndicator', ), false)) {
		$__finalCompiled .= '
								<li class="tag-staffIndicator"><span class="message-newIndicator message-staffIndicator">' . 'Staff' . '</span></li>
							';
	} else if ($__vars['post']['User']['is_banned'] AND $__templater->func('property', array('xbBannedIndicators', ), false)) {
		$__finalCompiled .= '
