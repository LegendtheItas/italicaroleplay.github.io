<?php
// FROM HASH: 4d4ee28b925fe4aa2065ff059bb76820
...
'forum' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['extras']['hasNew'] AND $__templater->func('property', array('xbNewIndicator', ), false)) {
	...
	if ($__vars['xf']['visitor']['is_admin'] AND $__templater->func('property', array('xbNodeIDHelper', ), false)) {
		$__finalCompiled .= '<span class="xbNodeID">.node.node--id' . $__templater->escape($__vars['node']['node_id']) . ' .node-icon i:before { content: "\\f075";}</span>';
	}
	$__finalCompiled .= '
